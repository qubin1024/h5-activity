      ...
      <div id="contentBox" ref="bg-main">
            ...
            <div class="middle">
                ...
                ">{{formD.phone}}</span>
                    ...
                    <span style="display: block;font-size: 0.5rem;color: #843493;padding: 0 15px;text-align: center;" @click="initQQMap">{{formD.address}}</span>
...
export default {
  ...
  methods: {
    ...
    addActive() {
      ...
      this.$http
        .post(baseUrl.apiBaseUrl + "gather/makeLike", {
        ...
        .then(({ data }) => {
          if (data.code == 0) {
            ...
            this.shown = false;
            this.$http
              .post(baseUrl.apiBaseUrl + "gather/queryPrizeLog", {
                id: this.shareId
              })
              .then(({ data }) => {
                if (data.code == "0000") {
    ...
    addZan() {
      ...
      this.$http
        .post(baseUrl.apiBaseUrl + "gather/like", {
          activityId: this.params.id,
          id: this.shareId,
          likes: this.user_id
        })
        ...
        this.$http
          ...
          .then(({ data: res }) => {
            if (res.code != "0000") {
              ...
              this.loading = true;
              this.$http
                .get(baseUrl.apiBaseUrl + "gather/info/" + params.id)
                .then(({ data }) => {
                  if (data.code == "0") {
