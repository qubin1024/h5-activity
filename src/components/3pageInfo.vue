...
export default {
    ...
    methods: {
            ...
            this.$http.post("https://wx.sharkmeida.cn/api/order/saveOrder", {
                ...
                if(data.code == 0){
                   this.$vux.alert.show({
                     ...
                     this.$http.post("https://wx.sharkmeida.cn/api/order/getOrderByOrderId", {orderId: data.result.order.orderId}).then(({
                        data
                    }) => {
                        if(data.code == '0000'){
        ...
        addZan(){
            ...
            this.$http.post("https://wx.sharkmeida.cn/bargin/bargin", {
                activityId: this.params.id,
                ...
                if(data.code == 0){
                   this.$vux.alert.show({
                    ...
                    this.$http.post("https://wx.sharkmeida.cn/api/order/getOrderByOrderId", {orderId: this.shareId}).then(({
                        data
                    }) => {
                        if(data.code == '0000'){
                            this.prize = data.result.data.total_price;
        ...
        query() {
            ...
            if(!!params.shareId){
                this.$http.post("https://wx.sharkmeida.cn/api/order/getOrderByOrderId", {orderId: params.shareId}).then(({
                    data
                }) => {
                ...
                this.$http.post("https://wx.sharkmeida.cn/bargin/queryBarginLog", {orderId: params.shareId}).then(({
                    data
                }) => {
                    if(data.code == '0000'){
            ...
            this.loading = true
            this.$http.get("https://wx.sharkmeida.cn/bargin/info/" + params.id).then(({
                data
            }) => {
                if (data.code == "0") {
                        ...
                        .then((data, status) => {
                            ...
                            wx.ready(function () {
                                ...
                                var shareParam = {
                                    ...
                                    link: "https://wx.sharkmeida.cn/dist/redirect.html?id=" + params.id + "&userid=" + this.user_id + "&shareId=" + this.shareId + "&hash=3pageInfo", // 分享链接，该链接域名或路径必须与当前页面对应的公众号JS安全域名一致
